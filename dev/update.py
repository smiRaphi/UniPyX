...
def supdate(c:Cache,k:str,inf:dict):
    ...
    for f in inf['fs']:
        ...
        if u == '.': tts = -1
            ...
            if repo not in ('VirusTotal/yara','allcoolthingsatoneplace/UnrealPakTool','joncampbell123/dosbox-x','GotthardtZ/paq8gen','skandau/paq8sk','kaitz/paq8pxv','kaitz/fxcm'):
