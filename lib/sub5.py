...
def extract5(inp:str,out:str,t:str) -> bool:
    ...
    match t:
        case 'qbp'|'TANGELO'|'CSC'|'NLZM'|'GRZipII'|'BALZ'|'SR3'|'SQUID'|'CRUSH (I.M.)'|'LZPX'|'LZPXJ'|'THOR'|'ULZ'|'LZPM'|'Yappy'|'LZMAT':
        ...
        case 'PAQ8PX':
            ...
            if old:
                ...
                for ix in list(range(214,136,-1)) + ['136b'] + list(range(136,80,-1)) + ['80b'] + list(range(80,67,-1)):
